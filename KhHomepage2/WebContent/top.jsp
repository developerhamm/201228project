...
#news1{
 ...
 <body>
  <div id="ALL">
   ...
   <div id="homeregister">
      <a href="#">홈|</a>
      <a href="index.jsp?page=memberForm">회원가입|</a>
      ...
      <%
          ...
          if(id!=null){
        	  ...
        	  out.print("<a href=index.jsp?page=member/memberlist>회원목록</a><br>");
        	  out.print("<a href=index.jsp?page=member/memberoutForm>회원탈퇴</a><br>");
          }
      %>       
      </div>   
   </div>
